...
const Skills = () => {
  const skillCategories = [
    ...
    {
      title: "Backend",
      skills: ["Node.js", "Express", "Firebase", "MongoDB", "GraphQL", "REST API"],
    },
    {
      title: "DevOps",
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-primary-400 text-center">
        Skills
      </h1>
        ...
        {trail.map((style, index) => (
          <animated.div key={index} style={style}>
            <FlipCard isFlipped={isFlipped[index]} flipDirection="horizontal">
              ...
              <div
                className="flex items-center gap-2 justify-center bg-primary-500 rounded-lg shadow-md px-10 py-6 cursor-pointer"
                onClick={() => toggleFlip(index)}
              >
                <h2 className="text-2xl font-bold text-primary-30">
              ...
              <div
                className="bg-primary-500 rounded-lg shadow-md px-10 py-6 cursor-pointer"
                onClick={() => toggleFlip(index)}
              >
