...
const index = (props: Props) => {
  return <>
    <Resume />
      <div className='flex w-[27%] mt-2 justify-center drop-shadow-2xl rounded-b-full bg-gradient-to-b from-transparent to-primary-50'>
          <Image
            src={mainImage}
            alt="me"
            width={360}
